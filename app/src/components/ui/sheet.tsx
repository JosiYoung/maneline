...
// shadcn/ui Sheet — side-anchored Radix Dialog. Added in Phase 2 so the
// Trainer Portal's mobile sidebar can slide in from the left per
// FRONTEND-UI-GUIDE.md §3.5. Animations rely on `tailwindcss-animate`,
// already enabled in src/styles/index.css:2.
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "font-display text-lg font-semibold leading-none tracking-tight text-primary",
      className
    )}
    {...props}
  />
